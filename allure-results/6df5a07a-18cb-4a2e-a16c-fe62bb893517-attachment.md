...
- Location: tests\visualTesting.spec.ts:19:9

# Error details

```
Error: A snapshot doesn't exist at C:\Users\LalitGupta\Desktop\NewvisionTraining\Automation_Exercise_Project\tests\visualTesting.spec.ts-snapshots\website-logo-chromium-win32.png, writing actual.
```
