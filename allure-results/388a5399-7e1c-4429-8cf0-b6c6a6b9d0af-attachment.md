...
- Name: 1_Registration\registration.spec.ts >> Registration Module - All Test Cases >> TC06 - Empty Password Validation
- Location: tests\1_Registration\registration.spec.ts:39:9
...
```ts
  ...
  5   | import { RegistrationPage } from "../Pages/1_registrationPage";
  6   |  
