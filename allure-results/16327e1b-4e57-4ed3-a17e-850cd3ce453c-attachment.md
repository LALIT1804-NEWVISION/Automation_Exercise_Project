...
Call log:
  ...
  - fonts loaded
  - Expected an image 1265px by 8944px, received 1265px by 8819px. 11259 pixels (ratio 0.01 of all image pixels) are different.
...
> 16 |         await expect(page).toHaveScreenshot('automation-homepage.png', {fullPage: true,maxDiffPixels: 200});
     |                            ^ Error: expect(page).toHaveScreenshot(expected) failed
  17 |     });
  18 | 
