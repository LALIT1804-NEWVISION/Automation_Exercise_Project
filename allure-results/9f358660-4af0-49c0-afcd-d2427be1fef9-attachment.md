...
- Name: visualTesting.spec.ts >> Automation Exercise - Visual Testing >> TC01 - Homepage Banner Comparison
- Location: tests\visualTesting.spec.ts:23:9
...
Locator: locator('//section[@id=\'slider\']//div[@class=\'container\']')
  Expected an image 1265px by 487px, received 1171px by 442px. 117688 pixels (ratio 0.20 of all image pixels) are different.

  Snapshot: homepage-banner.png

Call log:
  - Expect "toHaveScreenshot(homepage-banner.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('//section[@id=\'slider\']//div[@class=\'container\']')
