...
- Name: visualTesting.spec.ts >> Automation Exercise - Visual Testing >> TC02 - Logo Validation
- Location: tests\visualTesting.spec.ts:36:9
...
Locator: locator('img[alt="Website for automation practice"]')
  Expected an image 263px by 92px, received 264px by 92px. 

  Snapshot: website-logo.png

Call log:
  - Expect "toHaveScreenshot(website-logo.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('img[alt="Website for automation practice"]')
    - locator resolved to <img src="/static/images/home/logo.png" alt="Website for automation practice"/>
...
```ts
  ...
  12 | 
  13 |         await expect(page).toHaveURL('https://automationexercise.com/');
  14 |         await expect(
  15 |             page.locator('//*[@class="fa fa-home"]/ancestor::a')
  16 |         ).toBeVisible();
  17 | 
  ...
  21 | 
  22 | 
  23 |     test('TC01 - Homepage Banner Comparison', async ({ page }) => {
  24 |         // Stable banner section instead of full page
  25 |         const banner = page.locator("//section[@id='slider']//div[@class='container']");
  26 | 
  27 |         await expect(banner).toBeVisible();
  28 | 
  29 |         await expect(banner).toHaveScreenshot('homepage-banner.png', {
  30 |             maxDiffPixels: 500,
  31 |             animations: 'disabled'
  32 |         });
  33 |     });
  34 | 
  35 | 
  36 |     test('TC02 - Logo Validation', async ({ page }) => {
  37 |         const logo = page.locator(
  38 |             'img[alt="Website for automation practice"]'
  39 |         );
  40 | 
  41 |         await expect(logo).toBeVisible();
  42 | 
> 43 |         await expect(logo).toHaveScreenshot('website-logo.png', {
     |                            ^ Error: expect(locator).toHaveScreenshot(expected) failed
  44 |             maxDiffPixels: 100
  45 |         });
  46 |     });
  47 | 
  48 | });
