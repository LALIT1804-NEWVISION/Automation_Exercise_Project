...
- Name: Registration\registration.spec.ts >> Registration Module - All Test Cases >> TC09 - Invalid Mobile Number Validation
- Location: tests\Registration\registration.spec.ts:73:9
...
```ts
  ...
  2  | import registrationData from "../../src/Json_data/registration.json";
  3  | import { RegistrationAction } from "../../src/Actions/registrationAction";
  4  | import { ProductPage } from "../../src/Pages/productPage";
  5  | 
  6  | type AppActions = {
  7  |     registration: RegistrationAction;
  8  | };
  9  | 
  10 | type Fixtures = {
  11 |     gotoBaseUrl: void;
  ...
  16 |     gotoBaseUrl: [
  17 |         async ({ page }, use) => {
> 18 |             await page.goto(registrationData.baseUrl);
     |                        ^ Error: page.goto: Test timeout of 30000ms exceeded.
  19 |             await use();
  20 |         },
  21 |         { auto: true }
  22 |     ],
  23 | 
  24 |     appAction: async ({ page }, use) => {
  25 |         const appAction: AppActions = {
  26 |             registration: new RegistrationAction(page),
  27 |         };
  28 | 
