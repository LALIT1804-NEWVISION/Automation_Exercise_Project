...
- Name: visualTesting.spec.ts >> example test
- Location: tests\visualTesting.spec.ts:3:5

# Error details

```
Error: A snapshot doesn't exist at C:\Users\LalitGupta\Desktop\NewvisionTraining\Automation_Exercise_Project\tests\visualTesting.spec.ts-snapshots\example-test-1-chromium-win32.png, writing actual.
```
