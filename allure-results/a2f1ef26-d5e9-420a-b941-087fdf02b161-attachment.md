...
```
Error: A snapshot doesn't exist at C:\Users\LalitGupta\Desktop\NewvisionTraining\Automation_Exercise_Project\tests\visualTesting.spec.ts-snapshots\homepage-banner-chromium-win32.png, writing actual.
```
