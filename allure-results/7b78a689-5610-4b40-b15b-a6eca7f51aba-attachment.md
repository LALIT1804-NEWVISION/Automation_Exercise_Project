_IXd5x3eqfYxDC5eT4Qb6XNePrjGgZHpjZ6X4WwEdMzjnxpe9eYum27BMDS--6NTS9JYn_TcOdnsGrWKQ942G9yYkVSmFM4efUofKXwqX_6edTKJwIApFL1Z8cBYRuzgUBl1S9SgBu_dKt6F07w1_G2GaK94O_-WWcBoG67v6yulGT9-LMIMy0nxt5KvpjXJkznbAkom7uRtqY9XU83YJpV5ugARgB&sig=AOD64_1-aeAid3RtCOTcgrvG-A2d0vjZvg&client=ca-pub-1677597403311019&rf=2&nb=2&adurl=https://www.zoho.com/in/payments/industry/education/%3Fnetwork%3Dd%26device%3Dc%26keyword%3D%26campaignid%3D23666506454%26creative%3D800878282936%26matchtype%3D%26adposition%3D%26placement%3Dautomationexercise.com%26adgroup%3D197494335514%26targetid%3D%26gad_source%3D5%26gad_campaignid%3D23666506454%26gclid%3DEAIaIQobChMIzeOD04-OlAMVaDdECB0DjgmBEAEYASAAEgKp6fD_BwE
...
```ts
  ...
  2  | 
  3  | test.describe('Automation Exercise - Visual Testing', () => {
  4  | 
  ...
  8  | 
  9  |         // Verify URL
  10 |         await expect(page).toHaveURL(/automationexercise/);
  11 | 
  12 |         // Verify Home icon is visible
  13 |         await expect(
  14 |             page.locator('//*[@class="fa fa-home"]/ancestor::a')
  15 |         ).toBeVisible();
  16 | 
  17 |         // Wait for complete page load
> 18 |         await page.waitForLoadState('networkidle');
     |                    ^ Error: page.waitForLoadState: Test timeout of 30000ms exceeded.
  19 |     });
  20 | 
  21 | 
  22 |     test('TC01 - Full Page Image Comparison', async ({ page }) => {
  23 |         // Verify page title
  24 |         await expect(page).toHaveTitle(/Automation Exercise/);
  25 | 
  26 |         // Full page screenshot comparison
  27 |         await expect(page).toHaveScreenshot('automation-homepage.png', {
  28 |             fullPage: true,
  29 |             maxDiffPixels: 200
  30 |         });
  31 |     });
  32 | 
  33 | 
  34 |     test('TC02 - Element Comparison - Logo Validation', async ({ page }) => {
  35 |         // Locate logo element
  36 |         const logo = page.locator('img[alt="Website for automation practice"]');
  37 | 
  38 |         // Verify logo visibility
  39 |         await expect(logo).toBeVisible();
  40 | 
  41 |         // Element screenshot comparison
  42 |         await expect(logo).toHaveScreenshot('website-logo.png', {
  43 |             maxDiffPixels: 50
  44 |         });
  45 |     });
  46 | 
